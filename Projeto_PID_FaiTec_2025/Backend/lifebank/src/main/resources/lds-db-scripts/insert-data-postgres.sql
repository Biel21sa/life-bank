...
('Ana Souza', 'USER', '44444444444', 'ana@example.com', '(11) 98888-0001', 'aa', 'Rua Bela', '101', 'Centro', '13001-000', NULL),
('Lucas Lima', 'USER', '55555555555', 'lucas@example.com', '(11) 98888-0002', 'aa', 'Av. Brasil', '102', 'Jardins', '13002-000', NULL),
('Fernanda Rocha', 'USER', '66666666666', 'fernanda@example.com', '(11) 98888-0003', 'aa', 'Rua das Árvores', '103', 'Planalto', '13003-000', NULL),
('Tiago Pereira', 'USER', '77777777777', 'tiago@example.com', '(11) 98888-0004', 'aa', 'Rua Nova', '104', 'Centro', '13004-000', NULL);
...
INSERT INTO user_model (name, role, cpf, email, phone, password, street, number, neighborhood, postal_code, donation_location_id) VALUES
('Juliana Alves', 'USER', '88888888888', 'juliana@example.com', '(11) 98888-0005', 'aa', 'Rua Nova Esperança', '105', 'Jardim Esperança', '13005-000', NULL),
('Rafael Costa', 'USER', '99999999999', 'rafael@example.com', '(11) 98888-0006', 'aa', 'Av. das Américas', '106', 'América', '13006-000', NULL),
('Paulo Henrique', 'USER', '10101010101', 'paulo@example.com', '(11) 98888-0007', 'aa', 'Rua Central', '107', 'Centro', '13007-000', NULL);
